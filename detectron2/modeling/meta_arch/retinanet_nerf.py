...
RETINANET_NERF_REGISTRY = Registry("RetinaNet_nERF")

# @META_ARCH_REGISTRY.register()
@RETINANET_NERF_REGISTRY.register()
class RetinaNet_Nerf(DenseDetector):
    """
    ...
    def __init__(
        ...
        *,
        ...
        logger.info('NK: META_ARCH_REGISTRY')
        # self.head = NeRF_Head_RetinaNet(nerfWeights, flagConv4feats=True)
    ...
    def from_config(cls, cfg):
        ...
        # nerfWeights = torch.load('/media/nahyun/HDD/nerf_weights/nerf_weights_10k.pth')
        # head = NeRF_Head_RetinaNet(nerfWeights, flagConv4feats=True)
...
class RetinaNetHead_Nerf(nn.Module):
    """
...
class NeRF_Head_RetinaNet(nn.Module):
    def __init__(self, nerfWeights, flagConv4feats=False, actMapDim=900):
        # NeRFWeights: 
